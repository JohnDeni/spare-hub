...
const dict = {
  en: {
    ...
    "reviews.error.auth": "Sign in to leave a review.",
    "reviews.error.generic": "Could not save your review. Try again.",
    "reviews.form.comment": "Comment",
    "reviews.form.commentPlaceholder": "What worked well? Would you buy again?",
    "reviews.form.ownListing": "You can't review your own listing.",
    "reviews.form.rating": "Rating",
    "reviews.form.ratingValue": "{value} stars",
    "reviews.form.signIn": "Sign in to leave a review.",
    "reviews.form.submit": "Post review",
    "reviews.images.add": "Add photos",
    "reviews.images.delete": "Remove photo",
    "reviews.images.success": "Photos added",
    "reviews.loading": "Loading reviews…",
    "reviews.reply.action": "Reply",
    "reviews.reply.label": "Your reply",
    "reviews.reply.placeholder": "Write a reply",
    "reviews.reply.submit": "Post reply",
    "reviews.reply.success": "Reply posted",
    "reviews.save": "Save",
    "reviews.success": "Review posted",
  ...
  uk: {
    ...
    "reviews.anonymous": "Покупець",
    "reviews.cancel": "Скасувати",
    "reviews.count": "{count} відгуків",
    "reviews.delete": "Видалити відгук",
    "reviews.deleted": "Відгук видалено",
    "reviews.edit": "Редагувати відгук",
    "reviews.empty": "Відгуків ще немає. Напишіть перший.",
    "reviews.error.auth": "Увійдіть, щоб залишити відгук.",
    "reviews.error.generic": "Не вдалося зберегти відгук. Спробуйте ще раз.",
    "reviews.form.comment": "Коментар",
    "reviews.form.commentPlaceholder": "Що сподобалось? Чи купили б знову?",
    "reviews.form.ownListing": "Не можна залишити відгук на власне оголошення.",
    "reviews.form.rating": "Оцінка",
    "reviews.form.ratingValue": "{value} зірок",
    "reviews.form.signIn": "Увійдіть, щоб залишити відгук.",
    "reviews.form.submit": "Надіслати відгук",
    "reviews.images.add": "Додати фото",
    "reviews.images.delete": "Видалити фото",
    "reviews.images.success": "Фото додано",
    "reviews.loading": "Завантаження відгуків…",
    "reviews.reply.action": "Відповісти",
    "reviews.reply.label": "Ваша відповідь",
    "reviews.reply.placeholder": "Напишіть відповідь",
    "reviews.reply.submit": "Надіслати відповідь",
    "reviews.reply.success": "Відповідь опубліковано",
    "reviews.save": "Зберегти",
    "reviews.success": "Відгук опубліковано",
    "reviews.title": "Відгуки",
    "reviews.updated": "Відгук оновлено",
    ...
    "seller.noListings": "У цього продавця немає активних оголошень.",
